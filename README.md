...
|12|在实验4的基础上修改了行内中diff_num+1,加入峰度和偏度(单5阶)|37.96/2.31|**0.30388**|2020.11.20|v13|
|13|在实验4的基础上,加入峰度和偏度(单5阶)|39.74/2.35|**0.30395**|2020.11.20|v14|
|14|在实验4的基础上,加入峰度和偏度(2-5)阶|40.10/2.36|**0.30476**|2020.11.20|v15|

**总结**：随机森林预测缺失值并不能带来明显提升，暂时不考虑加入该方法。可能是预测还是不太准，因为随机森林线下MSE大概为0.18-0.24之间。
